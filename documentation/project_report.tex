...
The next decision for the rate is illustrated in Figure \ref{fig:prob_algo}. Vectors 'w's are the values used as weights. Theses are than sum and a random number is generated within this sum. The algorithm will return the rate type associated to the random value generated. This process is repeated every cell generation.
